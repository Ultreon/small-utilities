...
public class PostMenu extends AbstractContainerMenu {
    ...
    public PostMenu(final int id, final Inventory inventory) {
        this(id, inventory, new SimpleContainer(SLOTS), ContainerLevelAccess.NULL);
    }

    public PostMenu(final int id, final Inventory inventory, final Container container, final ContainerLevelAccess access) {
